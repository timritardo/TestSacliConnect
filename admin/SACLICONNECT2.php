...
<div class="sidebar">
    ...
    <ul>
        ...
        <li><a href="SACLICONNECT2.php?page=main" onclick="loadAjaxPage('main', event, this)" class="sidebar-link <?php if($page === 'main') echo 'admin-active'; ?>"><img class="icon2" src="../assets/images/Adobe Express - file.png" alt="">User Dashboard</a></li>
        ...
        <li><a href="SACLICONNECT2.php?page=students" onclick="loadAjaxPage('students', event, this)" class="sidebar-link <?php if($page === 'students') echo 'admin-active'; ?>"><img class="icon2" src="../assets/images/male-student_11285864.png" alt="">Student Management</a></li>
        <li><a href="SACLICONNECT2.php?page=teachers" onclick="loadAjaxPage('teachers', event, this)" class="sidebar-link <?php if($page === 'teachers') echo 'admin-active'; ?>"><img class="icon2" src="../assets/images/school_11033562.png" alt="">Teacher Management</a></li>
        <li><a href="SACLICONNECT2.php?page=alumni" onclick="loadAjaxPage('alumni', event, this)" class="sidebar-link <?php if($page === 'alumni') echo 'admin-active'; ?>"><img class="icon2" src="../assets/images/student.png" alt="">Alumni Management</a></li>
         <li><a href="SACLICONNECT2.php?page=alumni_accounts" onclick="loadAjaxPage('alumni_accounts', event, this)" class="sidebar-link <?php if($page === 'alumni_accounts') echo 'admin-active'; ?>"><img class="icon2" src="../assets/images/student.png" alt="">Alumni Accounts</a></li>
        <li><a href="SACLICONNECT2.php?page=access_links" onclick="loadAjaxPage('access_links', event, this)" class="sidebar-link <?php if($page === 'access_links') echo 'admin-active'; ?>"><img class="icon2" src="../assets/images/network-access.png" alt="">Accesses page Manage</a></li>
        <li><a href="SACLICONNECT2.php?page=login_video_settings" onclick="loadAjaxPage('login_video_settings', event, this)" class="sidebar-link <?php if($page === 'login_video_settings') echo 'admin-active'; ?>"><img class="icon2" src="video-camera.png" onerror="this.src='../assets/images/network-access.png'" alt="">Update LOG IN video</a></li>
        <li><a href="SACLICONNECT2.php?page=achievements_manage" onclick="loadAjaxPage('achievements_manage', event, this)" class="sidebar-link <?php if($page === 'achievements_manage') echo 'admin-active'; ?>"><img class="icon2" src="../assets/images/badge.png" alt="">Achievements</a></li>
        <li><a href="SACLICONNECT2.php?page=eval_questions" onclick="loadAjaxPage('eval_questions', event, this)" class="sidebar-link <?php if($page === 'eval_questions') echo 'admin-active'; ?>"><img class="icon2" src="../assets/images/5icons8-assignment-50.png" alt="">Evaluation Questions</a></li>
        <li><a href="SACLICONNECT2.php?page=calendar" onclick="loadAjaxPage('calendar', event, this)" class="sidebar-link <?php if($page === 'calendar') echo 'admin-active'; ?>"><img class="icon2" src="../assets/images/calendar.png" alt="">Calendar Events</a></li>
        <li><a href="SACLICONNECT2.php?page=passwords" onclick="loadAjaxPage('passwords', event, this)" class="sidebar-link <?php if($page === 'passwords') echo 'admin-active'; ?>"><img class="icon2" src="../assets/images/access-control.png" onerror="this.src='../assets/images/access-control.png'" alt="">Passwords</a></li>
        <li><a href="SACLICONNECT2.php?page=chats" onclick="loadAjaxPage('chats', event, this)" class="sidebar-link <?php if($page === 'chats') echo 'admin-active'; ?>"><img class="icon2" src="../assets/images/communication.png" alt="">Chat Monitoring</a></li>
        <li><a href="SACLICONNECT2.php?page=concerns" onclick="loadAjaxPage('concerns', event, this)" class="sidebar-link <?php if($page === 'concerns') echo 'admin-active'; ?>"><img class="icon2" src="../assets/images/anxiety.png" alt="">Student Concerns</a></li>
        <li><a href="SACLICONNECT2.php?page=signup_manage" onclick="loadAjaxPage('signup_manage', event, this)" class="sidebar-link <?php if($page === 'signup_manage') echo 'admin-active'; ?>"><img class="icon2" src="../assets/images/Adobe Express - file.png" alt="">Signup Management</a></li>
        <li><a href="SACLICONNECT2.php?page=chat_themes" onclick="loadAjaxPage('chat_themes', event, this)" class="sidebar-link <?php if($page === 'chat_themes') echo 'admin-active'; ?>"><img class="icon2" src="../assets/images/communication.png" alt="">Chat Themes Manage</a></li>
        <li><a href="SACLICONNECT2.php?page=uploads" onclick="loadAjaxPage('uploads', event, this)" class="sidebar-link <?php if($page === 'uploads') echo 'admin-active'; ?>"><img class="icon2" src="../assets/images/folder.png" onerror="this.src='../assets/images/network-access.png'" alt="">Uploads</a></li>
        <li><a href="SACLICONNECT2.php?page=deactivated" onclick="loadAjaxPage('deactivated', event, this)" class="sidebar-link <?php if($page === 'deactivated') echo 'admin-active'; ?>"><img class="icon2" src="block-user.png" onerror="this.src='../assets/images/network-access.png'" alt="">Deactivated Accounts</a></li>
    </ul>
</div>
